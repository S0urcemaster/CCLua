...
local orientierung = "l" -- ist aenderbar mit setzRichtung("l" oder "r")

coords = {x=1, y=1, z=1, v=0}
...
-- Drehung ohne Beruecksichtigung der Orientierung
...
function orientierungUmkehren()
	if orientierung == "r" then orientierung = "l"
	else orientierung = "r" end
end


-- Drehung unter Bercksichtigung der Orientierung
function links()
...
function ausrichtenMitOrientierung(richtung)

	if orientierung == "r" then
...
function gehezu(x, y, z, fForward, fUp, fDown)
  z = z or 1
